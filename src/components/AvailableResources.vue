...
<template>
  ...
  <div class="mobile-resources-wrapper flex-1 overflow-hidden relative flex flex-col">
    ...
    <div class="mobile-fade-overlay absolute bottom-0 left-0 right-0 h-32 md:bg-gradient-to-t bg-gradient-to-l from-white dark:from-neutral-900 via-white/50 dark:via-neutral-900/50 to-transparent pointer-events-none z-[5]"></div>
  </div>

  <!-- Search Bar and Tabs Container -->
  <div class="mobile-tabs-search mt-auto sticky bottom-0 z-10 w-full flex-shrink-0 bg-white dark:bg-neutral-900 md:border-t-0">
